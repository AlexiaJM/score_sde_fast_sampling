...
def get_dataset(config, additional_dim=None, uniform_dequantization=False, evaluation=False, drop_remainder=True):
  ...
  if config.data.dataset == 'CIFAR10':
    dataset_builder = tfds.builder('cifar10', data_dir=config.data.dir)
    ...
    dataset_builder = tfds.builder('svhn_cropped', data_dir=config.data.dir)
    train_split_name = 'train'
    eval_split_name = 'test'
    ...
    dataset_builder = tfds.builder('celeb_a', data_dir=config.data.dir)
    train_split_name = 'train'
    ...
    dataset_builder = tfds.builder(f'lsun/{config.data.category}', data_dir=config.data.dir)
    train_split_name = 'train'
    eval_split_name = 'validation'
